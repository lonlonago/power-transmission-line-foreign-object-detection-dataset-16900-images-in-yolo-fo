# Power Transmission Line Foreign Object Detection Dataset 16900 images in YOLO format

# Body

Power Line Object Identification Detection Dataset, 16900 images in YOLO format, clear pictures, complete annotations, suitable for power line object detection, target recognition, model training.
or change.
can

Category: ['Blown', 'Defects', 'Foreign Object', 'Insulator', 'Bird Nest
